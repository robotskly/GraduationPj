package com.example.graduationpj.module.navigation.overlays;
...
public class RouteOverlay {
	...
	protected BitmapDescriptor getStartBitmapDescriptor() {
		return BitmapDescriptorFactory.fromResource(R.drawable.icon_start_place);
	}
	/**
	...
	protected BitmapDescriptor getEndBitmapDescriptor() {
		return BitmapDescriptorFactory.fromResource(R.drawable.icon_end_place);
	}
